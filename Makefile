...
CFLAGS += -DCONFIG_MACH_SUN7I=1 -gdwarf-2 -mthumb-interwork
CFLAGS += -Wall -MMD -pipe -fno-stack-protector -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=0
...
LDFLAGS += -Map=output.map -T lscript.lds
